...
public class LoggerInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(session != null) {
			System.out.println("------------");
			System.out.println("username_ss = "+session.getAttribute("username"));
			if(AccountController.getUser() != null) {
				System.out.println("username_login = "+AccountController.getUser().getUsername());
				session.setAttribute("username", AccountController.getUser().getUsername());
				session.setAttribute("role", AccountController.getUser().getRole());
			}
